    ...
    <AnimatePresence>
      {open ? (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-50 flex items-end justify-center overflow-y-auto bg-black/55 px-4 py-4 sm:items-center"
        >
          <motion.div
            ...
            className="flex max-h-[calc(100vh-2rem)] w-full max-w-2xl flex-col overflow-hidden rounded-[32px] border border-white/20 bg-white shadow-[0_30px_90px_rgba(0,0,0,0.28)]"
          >
            ...
            <div className="min-h-0 flex-1 overflow-y-auto">
              ...
              {error ? <p className="px-6 pb-4 text-sm text-rose-600">{error}</p> : null}
            </div>

            <div className="sticky bottom-0 flex flex-wrap items-center justify-between gap-3 border-t border-slate-100 bg-white px-6 py-5">
              <div>
                {vendor?.id ? (
